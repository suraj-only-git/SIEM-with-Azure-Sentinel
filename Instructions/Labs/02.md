...
3. Select **Hunting (1)** under the **Threat management** section, follow the below instructions to create a new hunt based on the installed **Log4J Vulnerability Detection** solution:
...
### Option 1: Use bookmarks [READ-ONLY]
