...
11. On **Create Data Collection Rule** page, click on **Next: Collect >**.

    ![](../media/collect.png)

12. On **Collect** page, follow the below instructions:
...
13. Review the configuration and click on **Create**.
...
14. On the **Microsoft Sentinel | Data connectors** page, notice that now the **Windows Security Events via AMA** data connector is successfully connected with Microsoft Sentinel.
...
1. In the Search bar of the Azure portal, type **Sentinel (1)**, then select **Microsoft Sentinel (2)**.
 ...
 3. Within the Microsoft Sentinel page, in the left navigation pane, click on **Content hub (1)** under the **Content management** section. Search **(2)** for and select **(3)** **Microsoft 365**. Click on the **Install (4)** button in the right navigation pane that shows up thus, resulting in installation of the Microsoft 365 Solution.
      ...
      >**Note**: The installation may take up to a minute. Wait for the **Install Success** notification after which you can notice that the **Installed** count has been increased to **4**.
