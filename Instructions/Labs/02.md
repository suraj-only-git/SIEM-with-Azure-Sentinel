...
2. Once installed, select **Log4J Vulnerability Detection** solution and click on the **Actions (1)** button from the right navigation pane that appears. Choose the **+ Create hunt (preview) (2)** to create a new hunt directly from the content hub page.
