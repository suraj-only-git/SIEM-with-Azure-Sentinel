...
* [Task 3: Add a query to the hunt]([#task-2-create-a-hunt](#task-3-add-a-query-to-the-hunt))
* [Task 4: Add and view the bookmark](#task-4-add-and-view-the-bookmark)
* [Task 5: Interact with entities]([#task-2-create-a-hunt](#task-5-interact-with-entities))
* [Task 6: Create incidents]([#task-2-create-a-hunt](#task-6-create-incidents))
