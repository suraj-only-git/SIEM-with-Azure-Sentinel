...
### Task 2.1: Connect an Azure Windows Virtual Machine to Microsoft Sentinel
 ...
 6. From the **Data Connectors (1)** tab, under the **Configuration** section in the left navigation pane of the Microsoft Sentinel page, select the **Windows Security Events via AMA (2)** connector from the available list and click on **Open connector page (3)** from the right navigation pane that shows up.
 ...
 10. Expand the resource group **siem-sentinel (1)**,  select the windows virtual machine named **labvm-<inject key="Deployment-id" enableCopy="false"> (2)** and then click on **Apply (3)**.
 ...
 11. Back on the **Create Data Collection Rule** page, select **Next: Collect >** and then **Next: Review + create**.

 12. After the successful validation run, click on **Create**.
