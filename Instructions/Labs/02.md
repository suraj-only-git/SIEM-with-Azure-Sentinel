...
4. Select **Run all queries** and wait for the queries to execute. This process may take a couple of minutes.
...
7. Within the **Results** pop-up dialog box, ensure to select **(1)** only the check boxes analogous to a **1**, **3** and **5**. Click on **Apply (2)** to filter out the queries having atleast 1 result for better visibility. 
...
1. On the Microsoft Sentinel page, follow the below instructions to install the data connector:
     ...
     - Search for **Log4J Vulnerability Detection (2)** from the search bar and select it **(3)**.
     - Click on **Install (4)** in the right navigation pane that shows up.
...
3. Once installed, select **Log4J Vulnerability Detection** solution and click on the **Actions (1)** button from the right navigation pane that appears. Choose the **+ Create hunt (preview) (2)** to create a new hunt directly from the content hub page.
...
4. On the **Create hunt** page, follow the below instructions to create a new hunt based on the installed **Log4J Vulnerability Detection** solution:
...
5. Select **Hunting (1)** under **Threat management** section within the left navigation pane of the Microsoft Sentinel page and then click on the **Hunts (Preview) (2)** tab inorder to view the newly created hunt.
...
1. Select **Hunting (1)** under **Threat management** section within the left navigation pane of the Microsoft Sentinel page and click on the **Hunts (Preview) (2)** tab. Next, select **+ New hunt** inorder to create a blank hunt.
