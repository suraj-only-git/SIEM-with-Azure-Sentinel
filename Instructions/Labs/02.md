...
* [Task 3: Add a query to the hunt](#task-2-create-a-hunt)
* [Task 4: Add and view the bookmark](#task-2-create-a-hunt)
* [Task 5: Interact with entities](#task-2-create-a-hunt)
* [Task 6: Create incidents](#task-2-create-a-hunt)
* [Task 7: Track metrics](#task-2-create-a-hunt)
